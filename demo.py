...
def save_to_bin(tm: gt.TsetlinMachine, filename: str):
    ...
    n_states: int = 100  # TODO: figure out where this is
    ...
    # print(threshold, n_features, n_clauses, n_classes, n_states, boost_true_positive_feedback, weights, clauses)
    with open(filename, "wb") as f:
        ...
        f.write(n_states.to_bytes(4, "little", signed=True))
